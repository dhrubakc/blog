          ...
          <div class="col-md-12 portlets">
            <div class="panel panel-default">
              <div class="panel-heading">
                <div class="pull-left">Add result</div>
              ...
              <div class="panel-body">
                <div class="padd">
                  ...
                  <div class="form quick-post">
                    ...
                    <form class="form-horizontal" action="{{URL::to('/result')}}" method="POST" enctype="multipart/form-data">
                      <!-- Title -->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <textarea class="form-control" id="content" name="description">Description</textarea>
                        </div>
                      </div>
                      <!-- Content -->
                      <div class="form-group">
                        <label class="control-label col-lg-2" for="content">File</label>
                        <div class="col-lg-10">

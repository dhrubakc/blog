...
.item.active a img{
 ...
 <div class="col-lg-3 col-sm-4 col-xs-6"><a title="Image 3" href="#"><img class="thumbnail img-responsive" src="{{url::to('/').'/uploads/'.$gallery->image}}" data-full="{{url::to('/').'/uploads/'.$gallery->image}}"></a></div>
       @endforeach

              ...
              <div class="panel-body">
                <div class="padd">
                  ...
                  <div class="form quick-post">
                    ...
                    <form class="form-horizontal" action="{{URL::to('/chairmanmessage').'/'.$chairmanmessage->id}}" method="post">
                      <!-- Title -->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" class="form-control" id="title" name="title" value="{{$chairmanmessage->title }}">
                        </div>
                      </div>
                      <!-- Content -->
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <textarea class="form-control" id="content" name="description">{{$chairmanmessage->description}}</textarea>
                        </div>
                      </div>

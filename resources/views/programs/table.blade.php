      ...
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="{{url::to('/')}}/programs/create">Add new Programs</a></li>
                ...
                <thead>
                  ...
                  @foreach($programs_list as $programs)
                    <tr>
                      ...
                      <td>{{$programs->category->title}}</td>
                      <td>{!!$programs->description!!}</td>
                     <td>
                      
                        <a href="{{URL::to('/').'/programs/'.$programs->id.'/edit'}}"><button class="btn btn-primary pull-left" >Edit</button></a> &nbsp;&nbsp;&nbsp;&nbsp;
                     
                      <form action="{{URL::to('/').'/programs/'.$programs->id}}" method="POST" style="width: 65px;float: left;" >

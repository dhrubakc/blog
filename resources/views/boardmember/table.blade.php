      ...
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="{{url::to('/')}}/boardmember/create">Add  boardmember</a></li>
                  ...
                  @foreach($boardmember_list as $boardmember)
                    <tr>
                     ...
                     <td>
                        ...
                        <a href="{{URL::to('/').'/boardmember/'.$boardmember->id.'/edit'}}"><button class="btn btn-primary pull-left" >Edit</button></a> &nbsp;&nbsp;&nbsp;&nbsp;
                     
                      <form action="{{URL::to('/').'/boardmember/'.$boardmember->id}}" method="POST" style="width: 65px;float: left;" >

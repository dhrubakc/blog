          ...
          <div class="col-md-12 portlets">
            <div class="panel panel-default">
              <div class="panel-heading">
                <div class="pull-left">Add missionvission</div>
              ...
              <div class="panel-body">
                <div class="padd">
                  ...
                  <div class="form quick-post">
                    ...
                    <form class="form-horizontal" action="{{URL::to('/missionvission').'/'.$missionvission->id}}" method="post">
                      <!-- Title -->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" class="form-control" id="title" name="title" value="{{$missionvission->title }}">
                        </div>
                      </div>
                      <!-- Content -->
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <textarea class="form-control" id="content" name="description">{!!$missionvission->description!!}</textarea>
                        </div>
                      </div>

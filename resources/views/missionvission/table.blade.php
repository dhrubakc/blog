      ...
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="{{url::to('/')}}/missionvission/create">Add  missionvission</a></li>
              ...
              <table class="table table-striped table-advance table-hover">
                <thead>
                  ...
                  <?php 
                   $sn=0;
                   ?>
                  @foreach($missionvission_list as $missionvission)
                    <tr>
                      <td>{{++$sn}}</td>
                      <td>{{$missionvission->title}}</td>
                      <td>{!!$missionvission->description!!}</td>
                     <td>
                      
                        <a href="{{URL::to('/').'/missionvission/'.$missionvission->id.'/edit'}}"><button class="btn btn-primary pull-left" >Edit</button></a> &nbsp;&nbsp;&nbsp;&nbsp;
                     
                      <form action="{{URL::to('/').'/missionvission/'.$missionvission->id}}" method="POST" style="width: 65px;float: left;" >

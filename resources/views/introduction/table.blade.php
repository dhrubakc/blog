      ...
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="{{url::to('/')}}/introduction/create">Add  introduction</a></li>
              ...
              <table class="table table-striped table-advance table-hover">
                <thead>
                  ...
                  <?php 
                   $sn=0;
                   ?>
                  @foreach($introduction_list as $introduction)
                    <tr>
                      <td>{{++$sn}}</td>
                     ...
                     <td>
                        ...
                        <a href="{{URL::to('/').'/introduction/'.$introduction->id.'/edit'}}"><button class="btn btn-primary pull-left" >Edit</button></a> &nbsp;&nbsp;&nbsp;&nbsp;
                     
                      <form action="{{URL::to('/').'/introduction/'.$introduction->id}}" method="POST" style="width: 65px;float: left;" >

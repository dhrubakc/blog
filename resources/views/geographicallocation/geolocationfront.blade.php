                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="wprt-headings clearfix text-center">
                                        <h2 class="heading">
                                             ...
                                             {!!$geographicallocation->title!!}
                                             @endforeach
                                        </h2>
                                        <p class="sub-heading">   @foreach($geographicallocation_list as $geographicallocation)
                                                <p class="text-justify">{!!$geographicallocation->description!!}</p>
                                                @endforeach</p>
                                    </div>

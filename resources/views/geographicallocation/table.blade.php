      ...
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="{{url::to('/')}}/geographicallocation/create">Add  geographicallocation</a></li>
              ...
              <table class="table table-striped table-advance table-hover">
                <thead>
                  ...
                  <?php 
                   $sn=0;
                   ?>
                  @foreach($geographicallocation_list as $geographicallocation)
                    <tr>
                      <td>{{++$sn}}</td>
                      <td>{{$geographicallocation->title}}</td>
                      <td>{!!$geographicallocation->description!!}</td>
                     <td>
                      
                        <a href="{{URL::to('/').'/geographicallocation/'.$geographicallocation->id.'/edit'}}"><button class="btn btn-primary pull-left" >Edit</button></a> &nbsp;&nbsp;&nbsp;&nbsp;
                     
                      <form action="{{URL::to('/').'/geographicallocation/'.$geographicallocation->id}}" method="POST" style="width: 65px;float: left;" >
